Module 'Schema',
  ...
  CustomerGroup : new Meteor.Collection 'customerGroups', transform: (doc)-> new Wings.Customer.CustomerGroup(doc)
  ...
  ProductGroup  : new Meteor.Collection 'productGroups' , transform: (doc)-> new Wings.Product.ProductGroup(doc)
  ...
  PricePolicy   : new Meteor.Collection 'pricePolicies' , transform: (doc)-> new Wings.Product.PricePolicy(doc)

  Sale          : new Meteor.Collection 'sales'         , transform: (doc)-> new Wings.Sale(doc)
  SaleDetail    : new Meteor.Collection 'saleDetails'   , transform: (doc)-> new Wings.Sale.SaleDetail(doc)
