Module 'Model',
  ...
  CustomerGroup : new Meteor.Collection 'customerGroups', transform: (doc)-> new Wings.CustomerGroup(doc)
  ...
  ProductGroup  : new Meteor.Collection 'productGroups' , transform: (doc)-> new Wings.ProductGroup(doc)
