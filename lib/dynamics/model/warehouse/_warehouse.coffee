class Model.Warehouse
  ...
  insert: ()->
    ...
    insertResult = Wings.IRUS.insert(Model.Warehouse, newWarehouse, Wings.Validators.warehouseCreate)
  ...
  update: (fields)->
    ...
    Wings.IRUS.update(Model.Warehouse, @_id, @, updateFields, Wings.Validators.warehouseUpdate)

  remove: -> Wings.IRUS.remove(Model.Warehouse, @_id)
